...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Aleja\Proyectos\Web\Python\SemanaTres'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Aleja\Proyectos\Web\Python\SemanaTres\Scripts\deactivate.nu'
